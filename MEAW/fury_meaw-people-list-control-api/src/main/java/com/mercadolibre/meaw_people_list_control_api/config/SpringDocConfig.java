...
import static com.mercadolibre.meaw_people_list_control_api.util.ScopeUtils.getScopeValue;
import static com.mercadolibre.meaw_people_list_control_api.util.ScopeUtils.isLocalScope;
  ...
  public OpenAPI customOpenAPI(
    ...
    Info info = new Info()
        ...
        .contact(
            new Contact()
                .name("edviglima")
                .email("edviges.lima@mercadolivre.com"));
