# Contributing to meaw-people-list-control-api
Welcome! We are glad that you want to contribute to meaw-people-list-control-api! :sparkling_heart:
...
Opening an issue is easy filling out [this](https://github.com/melisource/fury_meaw-people-list-control-api/issues/new?labels=bug&template=bug-template.md&title=%5BBUG%5D+%3Ctitle%3E) template.
...
[Feature Request Template](https://github.com/melisource/fury_meaw-people-list-control-api/issues/new?labels=enhancement&template=feature-request-template.md&title=%5BFEATURE%5D+%3Ctitle%3E).
